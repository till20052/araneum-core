...
var source = {
    scripts: [paths.scripts + 'app.module.js',
        ...
        // shared modules
        paths.scripts + 'shared/**/*.module.js',
        paths.scripts + 'shared/**/*.js'
...
var compassOptsThemes = {
    project: path.join(__dirname, '../'),
    css: 'build/css',
    sass: 'source/resource/sass/themes/', // themes in a subfolders
    image: 'build/img'
};
