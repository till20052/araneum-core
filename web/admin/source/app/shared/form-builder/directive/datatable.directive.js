(function () {
    ...
    datatableController.$inject = ['$scope', '$compile', 'DTOptionsBuilder', 'formDataService', '$translate', 'TranslateDatatablesService', '$state'];
    function datatableController($scope, $compile, DTOptionsBuilder, formDataService, $translate, translate, $state) {
